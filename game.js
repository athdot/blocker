...
document.body.style.backgroundColor = "black";
        ...
        if (window.innerWidth > window.innerHeight) {
            ...
            var sqw = Math.floor(window.innerWidth / squaresize) + 1;
            ...
            var sqh = Math.floor(window.innerHeight / squaresize) + 1;
            c.width = ww;
            c.height = (ww / sqw) * sqh;
        ...
        function GetPixel(x, y) {
            ...
            var p = ctxs.getImageData(x, y, 1, 1).data;
        ...
        function breakingSquare(x, y) {
            var ctxs = cs.getContext("2d");
            var darkness = 0.1;
            var runs = 0;
            var set = setInterval(function() {
                ctxs.fillStyle = blend_colors(GetPixel(x, y), "#9f9f9f", darkness);
                ctxs.fillRect(x, y, 1, 1);
                if (runs > 100) {
                    hazardSquare(x, y);
                    clearInterval(set);
        ...
        function randBreak() {
            var x = Math.floor((Math.random() * sqw) + 1);
            var y = Math.floor((Math.random() * sqh) + 1);
            breakingSquare(x, y);
        }
        ...
        function restOscript() {
            ...
            setInterval(function() {
                randBreak();
                var time = 1000 * Math.floor((Math.random() * 10) + 1);
            }, time);
